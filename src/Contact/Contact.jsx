...
export default function Contact() {
    const emailAddress = "knrakshith45@gmail.com"
    return (
...
<div style={{position:'relative',left:'55px',padding:'20px' ,display:'inline',fontWeight:'bold'}}><CgMail  style={{display:'inline'}}/>  :  <a className='dark:md:hover:text-fuchsia-600'   href={`mailto:${emailAddress}` }>knrakshith45@gmail.com</a> </div>
