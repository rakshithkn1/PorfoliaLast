...
function Projetcs() {
  return (
    ...
    <div className="flex justify-center items-center gap-3 mt-5 ">
      <div className="h-[70vh] w-[40vw] border uppercase text-2xl text-center flex flex-col gap-5 text-green-500 bg-gray-200">Projects
      <div className="text-blue-700 mt-8">  
                       
                            <div className="h-3 w-3  bg-#84cc16 inline-block rounded-full mr-2"></div> 
                            <div className="mb-8 inline-block">   Quiz App   </div>

                            <div className="mb-8  pl-[-5vw]">   Currency Converter of different countries  </div>
                            <div className="mb-8  pl-[-5vw]">   Random Password Generator   </div>
      ...
      <div className="h-[70vh] w-[40vw] border uppercase text-2xl text-center flex flex-col gap-5 text-green-500 bg-gray-200">Deployed Links
      <div className="text-gray-500 mt-8">  
                       
                             <div className="mb-8">   <a href="https://quizappmajorproject.netlify.app/" >Quiz App  </a></div>
                             <div className="mb-8">   <a href="https://currencyconverterusingreactsspeacial.netlify.app/" >Currency Converter of different countries   </a></div>
